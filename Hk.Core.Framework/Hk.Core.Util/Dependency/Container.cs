...
namespace Hk.Core.Util.Dependency
{
    ...
    public class Container : IContainer
    {
        ...
        {
            return WebHelper.HttpContext?.RequestServices != null ? GetServiceFromHttpContext(type, name) : GetService(type, name);
        }
        ...
        {
            var serviceProvider = WebHelper.HttpContext.RequestServices;
            if (name == null)
        ...
        public IServiceProvider Register(IServiceCollection services, Action<ContainerBuilder> actionBefore, params IConfig[] configs)
        {
            ...
            //return AspectCoreHelper.BuildServiceProvider(services);
        }
