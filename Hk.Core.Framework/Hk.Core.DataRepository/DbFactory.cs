...
using Hk.Core.DataRepository.Repository;
using Hk.Core.Util;
...
namespace Hk.Core.DataRepository
{
    ...
    public class DbFactory
    {
        ...
        public static IRepository GetRepository(Object obj = null, DatabaseType? dbType = null, string entityNamespace = null)
        {
            ...
            Type dbRepositoryType = Type.GetType("Hk.Core.DataRepository." + DbProviderFactoryHelper.DbTypeToDbTypeStr(_dbType) + "Repository");
